<template>
     <div>
        <div id="controls">
            ...
            <button type="button" :disabled="!controlsEnabled" class="btn btn-danger btn-lg btn-block"><i class="fa fa-power-off"></i> Emergency Power Off</button>
            <button type="button" :disabled="!controlsEnabled" class="btn btn-info btn-lg btn-block"><i class="fa fa-medkit"></i> Release Payload</button>
        </div>
